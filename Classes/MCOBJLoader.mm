...
-(void)loadObjFromFile:(NSString*)filename objkey:(NSString*)objkey {
    ...
    vertexTextures.resize(m_vertexTextureCount *3);
    ...
    for (int i = 0; i < m_vertexTextureCount; i++) {
        NSLog(@"%f \t %f \t %f", vertexTextures[i*3], vertexTextures[i*3+1], vertexTextures[i*3+2]);
    }
    ...
    for (int i = 0; i < m_faceCount; i++) {
        ...
        Cube_texture_coordinates[i*6] = vertexTextures[(faces[i*9+1]-1)*3];
        Cube_texture_coordinates[i*6+1] = vertexTextures[(faces[i*9+1]-1)*3+1];
        ...
        Cube_texture_coordinates[i*6+2] = vertexTextures[(faces[i*9+4]-1)*3];
        Cube_texture_coordinates[i*6+3] = vertexTextures[(faces[i*9+4]-1)*3+1];
        ...
        Cube_texture_coordinates[i*6+4] = vertexTextures[(faces[i*9+7]-1)*3];
        Cube_texture_coordinates[i*6+5] = vertexTextures[(faces[i*9+7]-1)*3+1];
